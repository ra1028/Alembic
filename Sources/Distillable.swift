...
extension JSON: Distillable {
    public static func distil(_ j: JSON) throws -> JSON {
        return j
    }
}

extension String: Distillable {
    public static func distil(_ j: JSON) throws -> String {
        return try cast(j)
    }
}

extension Int: Distillable {
    public static func distil(_ j: JSON) throws -> Int {
        return try cast(j)
    }
}

extension Double: Distillable {
    public static func distil(_ j: JSON) throws -> Double {
        return try cast(j)
    }
}

extension Float: Distillable {
    public static func distil(_ j: JSON) throws -> Float {
        return try cast(j)
    }
}

extension Bool: Distillable {
    public static func distil(_ j: JSON) throws -> Bool {
        return try cast(j)
    }
}
...
extension Int8: Distillable {
    public static func distil(_ j: JSON) throws -> Int8 {
        return try NSNumber.distil(j).int8Value
    }
}

extension UInt8: Distillable {
    public static func distil(_ j: JSON) throws -> UInt8 {
        return try NSNumber.distil(j).uint8Value
    }
}

extension Int16: Distillable {
    public static func distil(_ j: JSON) throws -> Int16 {
        return try NSNumber.distil(j).int16Value
    }
}

extension UInt16: Distillable {
    public static func distil(_ j: JSON) throws -> UInt16 {
        return try NSNumber.distil(j).uint16Value
    }
}

extension Int32: Distillable {
    public static func distil(_ j: JSON) throws -> Int32 {
        return try NSNumber.distil(j).int32Value
    }
}

extension UInt32: Distillable {
    public static func distil(_ j: JSON) throws -> UInt32 {
        return try NSNumber.distil(j).uint32Value
    }
}

extension Int64: Distillable {
    public static func distil(_ j: JSON) throws -> Int64 {
        return try NSNumber.distil(j).int64Value
    }
}

extension UInt64: Distillable {
    public static func distil(_ j: JSON) throws -> UInt64 {
        return try NSNumber.distil(j).uint64Value
    }
}
